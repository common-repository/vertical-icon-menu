							...
							<div class="wow-button-con">
								<?php
									if ( $action_links ) {
										...
										switch( $plugin["slug"] ){
											case "modal-window" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-modal-windows-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "side-menu" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-side-menus-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "mwp-countdown" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-countdowns-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "forms-creator" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-forms-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											...
											case "mwp-skype" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-skype-buttons-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "mwp-viral-signup" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-viral-signups-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "wow-facebook-login" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-facebook-login-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "wow-google-login" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-google-login-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "mwp-herd-effect" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-herd-effects-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "wow-icons" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/wow-icons-pro/" target="_blank">PRO VERSION</a></li>';
											break;
											
											case "bubble-menu" :
											echo '<li><a class="button-pro" aria-label="PRO VERSION" href="https://wow-estore.com/en/bubble-menu-pro/" target="_blank">PRO VERSION</a></li>';
											break;
